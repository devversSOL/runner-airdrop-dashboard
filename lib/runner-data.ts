...
export const ORDER_FLOW = [
  ...
  },
  {
    step: 2,
    label: "SWAP",
    source: "TITS POOL WALLET",
    status: "FILLED",
  },
  {
    step: 3,
    label: "INDEX",
    source: "PUMP.FUN TRADER SNAPSHOT",
    status: "SYNCED",
  },
  {
    step: 4,
...
// pump.fun traders receiving the $TITS airdrop — anyone who traded at least once qualifies
export const DISTRIBUTION_ACCOUNTS: DistributionAccount[] = [
  ...
  { rank: 5, handle: "@titsgod", wallet: "4bWc...mN1s", amount: 76_400, status: "processing" },
  ...
  { rank: 15, handle: "@gm.tits", wallet: "7yUE...q2Wd", amount: 15_640, status: "processing" },
